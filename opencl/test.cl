...
/* Y扫描线
 */
void SetGridValueY(__global MyPoint* plist,int i ,float x,int WI,int T,__global int* result,__global MyPoint* test,__global MyPoint* parray)
{
...
__kernel void GetGridValue(__global MyPoint* plist,float W,float H,float T,int WI,int HI,__global int* result,__global MyPoint* test,__global MyPoint* parray)
{
    ...
    else
    {
        ...
        SetGridValueY(plist,j,x,WI,T,result,test,parray);
    }
}